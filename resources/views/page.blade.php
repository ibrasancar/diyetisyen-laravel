...
@section('content')
    ...
    <section class="generic-banner relative">
        <div class="container">
            <div class="row height align-items-center justify-content-center" style="height: 200px;">
                <div class="col-lg-10">
                    <div class="generic-banner-content">
                        <h2 class="text-white">Diyetisyenler</h2>
                        <p class="text-white">Size yardımcı olacak favori diyetisyeninizi bulmak bir tuş uzağınızda.</p>
                    </div>
                </div>
            </div>
        </div>
