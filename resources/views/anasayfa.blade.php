        ...
        <div class="hero_slider_container">
            <div class="hero_slider owl-carousel">
                ...
                <div class="hero_slide">
                    <div class="hero_slide_background" style="background-image:url(http://ornek.test/images/slider_background.jpg);"></div>
                    <div class="hero_slide_container d-flex flex-column align-items-center justify-content-center">
                        <div class="hero_slide_content text-center">
                            <h1 data-animation-in="fadeInUp" data-animation-out="animate-out fadeOut">Kayıt olun ve <span>diyetisyeninizi</span> kapın!</h1>
                        </div>
                    </div>
                </div>
                <div class="hero_slide">
                    <div class="hero_slide_background" style="background-image:url(http://ornek.test/images/milestones_background.jpg);"></div>
                    <div class="hero_slide_container d-flex flex-column align-items-center justify-content-center">
                        <div class="hero_slide_content text-center">
                            <h1 data-animation-in="fadeInUp" data-animation-out="animate-out fadeOut">Çok çarpıcı bir <span>slogan!</span></h1>
                        </div>
                    </div>
                </div>
            ...
            <div class="hero_slider_left hero_slider_nav trans_200"><span class="trans_200">önceki</span></div>
            <div class="hero_slider_right hero_slider_nav trans_200"><span class="trans_200">sonraki</span></div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 hero_box_col">
                        <div class="hero_box d-flex flex-row align-items-center justify-content-start">
                            ...
                            <div class="hero_box_content">
                                <h2 class="hero_box_title">Diyetisyenlerimiz</h2>
                                <a href="{{ route('diyetisyen') }}" class="hero_box_link">diyetisyenleri gör</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 hero_box_col">
                        <div class="hero_box d-flex flex-row align-items-center justify-content-start">
                            ...
                            <div class="hero_box_content">
                                <h2 class="hero_box_title">Bi'şey İçin Kayıt Ol</h2>
                                <a href="{{ route('kullanici.kayit') }}" class="hero_box_link">kayıt ol</a>
                            </div>
                        </div>
                    </div>
